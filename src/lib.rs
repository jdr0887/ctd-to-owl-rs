...
// pub const MESH: &str = "http://identifiers.org/mesh/";
...
lazy_static! {
    ...
    pub static ref CHEMICAL_ENTITY: String = format!("{}{}", OBO, "CHEBI_24431");
    pub static ref GENE_ENTITY: String = format!("{}{}", OBO, "SO_0000704");
